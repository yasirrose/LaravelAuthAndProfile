																	...
																	<td valign="bottom" align="center">
																		<table cellspacing="0" cellpadding="0" border="0" align="center" style="font-family:Arial,Tahoma,Helvetica,sans-serif; color:#4c505d;">
																			<tbody>
																				<tr>
																					<td valign="bottom" align="center">
																						<a href=""> <img style="width:200px" alt="IMG" src="{{asset('public/assets/images/download.jpg')}}" style="margin-bottom:0px" title="img" vspace="0" hspace="0" border="0"></a>
																					</td>
																				</tr>
																			</tbody>
																		</table>
																	...
																	<td valign="top" align="center">
																		<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="font-family:Arial,Tahoma,Helvetica,sans-serif; color:#4c505d;">
																			<tbody>
																				...
																				<tr>
																					<td> Please use this PIN to activate your account. </td>
																				</tr>
																				<tr>
																					<td width="auto" valign="top" align="center">
																						<table width="300" cellspacing="0" cellpadding="0" border="0" align="center">
																							<tbody>
																								<tr>
																									<p style="color:#4c505d;margin-top:10px;margin-bottom:25px; font-family:Arial,Tahoma,Helvetica,sans-serif;"> <a href="#" style="border: 2px solid #15c;padding: 10px;background: #fff;color: #15c;text-decoration: none;">
																										<?php echo $pin; ?>
																	...
																	<td align="center">
																		<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#efefef" align="center">
																			<tbody>
																				...
																				<tr>
																					<td style="font-size:11px;line-height:18px;font-family:Arial,Tahoma,Helvetica,sans-serif;color:#8a8c93;font-weight:300;text-align:center" height="45"> © 2021. All rights reserved</td>
																				</tr>
																			</tbody>
																		</table>
																	</td>
